# 🤖 Laboratoire IA - Gradients & Foules

> **Remise : 7 jours après chaque labo, avant le prochain labo**  
> Tous les laboratoires doivent être complétés et les liens/fichiers mis à jour dans ce README
...
**📋 Code expérimental NVBoids.CS** :  🔴 LIEN DE CODE À REMPLIR 💢 Uploader le fichier dans GitHub   
> ⚠️ **Important** : NE PAS remettre tout le projet Unity, seulement le fichier .cs modifié  

### 📚 Documentation à compléter dans README
**📝 Explications sur les formats de données Unity** :  🔴 LIEN MARKDOWN À REMPLIR  
**📝 Explications sur les tableaux de données du code** :  🔴 LIEN MARKDOWN À REMPLIR  
**📝 Explications sur les fonctions mathématiques** :  🔴 LIEN MARKDOWN À REMPLIR  
